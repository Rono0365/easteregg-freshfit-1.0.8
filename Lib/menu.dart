...
*/
      ...
      var ii = sharedPreferences.getBool('recentx');
      ...
      var oo = jsonDecode(sharedPreferences.getString('recent'));
...
//card starts here
                                                                              ...
                                                                              child: Column(children: [
                                                                                ...
                                                                                InkWell(
                                                                                    onTap: () {
                                                                                      Navigator.push(
                                                                                        context,
                                                                                        MaterialPageRoute(builder: (context) => GroceryAppPageView()),
                                                                                      );
                                                                                    },
                                                                                    child: Row(children: [
                                                                                      Container(
                                                                          ...
                                                                          children: [
                                                                            InkWell(
                                                                              onTap: () async {
                                                                                ...
                                                                                setState(() {
                                                                                  sharedPreferences.setString('recent', food2.reversed.where((op) => op['owner'].toString() == widget.me.toString()).take(1).toList()[0]["id"].toString());

                                                                                  recent = food2.reversed.where((op) => op['owner'].toString() == widget.me.toString()).take(1).toList()[0]["id"].toString();
                                                                                });
                                                                              },
                                                                              child: Padding(padding: EdgeInsets.all(5.0), child: Icon(Icons.close, color: text1)),
                                                                            )
                                                                          ],
                                                                        ),
                                                                      ),
                                      ...
                                      food2 == null
                                          ...
                                          : ListTile(
                                              title: Row(children: [
                                                ...
                                                Text(
                                                  lang2 != "Kiswahili (🇰🇪)"
                                                      ? " What  ${widget.firstname} likes"
                                                      : " Imependekezwa Kwako ${widget.firstname}",
                                                  style: GoogleFonts.lato(
                                                      fontSize: 20,
                                                      color: text1,
                                                      fontWeight:
                                                    ...
                                                    ...food2.reversed
                                                        .where((op) =>
                                                            ...
                                                            widget.me
                                                                .toString())
                                                        .take(4)
                                                        .map((i) //increase by the number of users
                                                            //var index = sky.indexOf(i);
                                                            //sort here
                                                            =>
                                                            Container(
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              builder: (BuildContext bc) {
                                                                                return StatefulBuilder(
                                                                                          ...
                                                                                          Container(
                                                                                            ...
                                                                                            child: Row(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                subtitle:Text(
                                                                                                     (int.parse(k.split(',')[3].toString())/int.parse(k.split(',')[2].toString())*int.parse(quantity.toString())).round().toString(),
                                                                                                        ...
                                                                                                        Container(
                                                                                                          child: InkWell(
                                                                                                            child: CircleAvatar(
                                                                                                              ...
                                                                                                              radius: 15,
                                                                                                              backgroundColor: darkmode ? Colors.grey[200]?.withOpacity(0.4) : Colors.grey[200],
                                                                                                            ),
                                                                                                            onTap: () {
                                                                                                              setState(() {
                                                                                                                quantity++;
                                                                                                        ...
                                                                                                        if (!amount3.contains(k)) {
                                                                                                          setState(() {
                                                                                                            ...
                                                                                                            amount2.add([
                                                                                                              k.split(',')[0].toString(),
                                                                                                              k.split(',')[1].toString(),
                                                                                                              //i['food'].replaceAll("],", "|").replaceAll("[", "").replaceAll("]]", "").split("|")[0].split(",")[1].toString().replaceAll(" ", ""),
                                                                                                              quantity,
                                                                                                              (int.parse(k.split(',')[3].toString())/int.parse(k.split(',')[2].toString())*int.parse(quantity.toString())).round(),
                                                                                                   //
                                                                                                            ]);
                                                                                                            amount3.add(i);
                                                                                                            amount.add((int.parse(k.split(',')[3].toString())/int.parse(k.split(',')[2].toString())*int.parse(quantity.toString())).round(),
                                                                                                   );
                                                                                                            quantity = 1;
                                                                                                          });
                                                                                                          Navigator.of(context).pop();
                                                                                  ...
                                                                                  //this has brainfucked me for the past 2 days
                                                                                },
                                                                                child: Card(
                                                                                    color: scaffold1,
                                                                                    elevation: 0,
                                                                                    child: Container(
                                                                                        ...
                                                                                        decoration: BoxDecoration(
                                                                                          ...
                                                                                          image: DecorationImage(
                                                                                            image: NetworkImage(k.split(',')[1].replaceAll(" ", '').toString()),
                                                                                            fit: BoxFit.cover,
                                                                                          ),
                                                                                        ),
                                                                                        child: Column(children: [
                                                                                          Container(
                                                                                            ...
                                                                                            child: ListTile(
                                                                                              ...
                                                                                              title: null,
                                                                                              //trailing: Container(color: scaffold1.withOpacity(0.3), child: Icon(Icons.more_vert, color: text1, size: 21)
                                                                                            )
                                                                                            ...
                                                                                            /*Container(
                                                                                                                          child:Row(
                                                                                                                            ...
                                                                                                                            children:[
                                                                                                                              Icon(Icons.star,size:20,color:Colors.yellow.shade600),Text("(1)",style:TextStyle(fontSize:15,color:Colors.black))
                                                                                                                            ]
                                                                                                                          )
                                                                                                                        )*/
                                                                                            ,
                                                                                          ...
                                                                                          /*Container(
                                                                                                                ...
                                                                                                                //law[1]
                                                                                                                    child:ListTile(
                                                                                                                      title: Container(
                                                                                                                        width:7,
                                                                                                                        child:Text(k.split(',')[0].toString(), overflow: TextOverflow.ellipsis,style: GoogleFonts.rubik(
                                                                                                                          fontSize:15,
                                                                                                                        ...
                                                                                                                        trailing:Container(
                                                                                                                          //height:10,
                                                                                                                          child:Icon(Icons.more_vert,color:text1,size:21),)
                                                                                                                    ),
                                                                                                                    /*Row(
                                                                                                                      mainAxisAlignment:MainAxisAlignment.spaceBetween,
                                                                                                                      children:[
                                                                        
                                                                                                                        Text(law[1], style: GoogleFonts.rubik(
                                                                                                                          fontSize:18,
                                                                                                                        ...
                                                                                                                        Container(
                                                                                                                          child:Row(
                                                                                                                            children:[
                                                                                                                              Icon(Icons.star,color:Colors.yellow.shade600),Text("(5)",style: GoogleFonts.rubik(
        ...
        //title: Text('name',style:GoogleFonts.lato(color:Colors.black)),
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                              ...
                                                                              child: Column(children: [
                                                                                ...
                                                                                Row(children: [
                                                                                  Text("0705412626", style: TextStyle(color: Colors.green)),
                                                                                ]),
                                                                              ])),
                                                                        ])),
                                                              ]),
                                                ...
                                                ListTile(
                                                  // leading:Icon(Icons.groups,color:Colors.orange),
                                                  title: Row(children: [
                                                    Icon(Icons.groups,
                                                        color: Colors.orange),
                                                    Text(
                                                          ...
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: Center(
                                                                child: ListTile(
                                                                    title: Text(
                                                                  "This feature is not yet available in your area",
                                                                  textAlign:
                                                                      TextAlign
                                                                          .center,
                                                                  style: GoogleFonts.lato(
                                                                  ...
                                                                  children: [
                                                                    ListTile(
                                                                      ...
                                                                      subtitle:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              ii == i['name'] ? (int.parse(i['price']) * quantity).toString() + 'KES' : i['price'].toString() + 'KES',
                                                                              style: GoogleFonts.lato(
                                                                                  /*backgroundColor: Colors
                                                                        .red
                                                                        .withOpacity(
